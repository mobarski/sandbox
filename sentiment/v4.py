...
chory			m		chor[zaeouy]\w*			# 6087 choreo
...
fortel			.		fortel				# 3
garb			f		garb\w+				# 111 garbarnia
geba			f		g[ęe]b[eayio]\w*		# 467 spongebob
gimby			.		gimb\w+				# 280
...
morda			f		mord(?!er)				# TODO >5000 morda
...
opium			.		opium				# 51
opozniony		m		(o|za)p[óo][źz]nion\w		# 75
...
podly			i		pod[łl][ay]\w+			# 174
pokurcz			if		pokurcz				# 42
polglowek		i		p[óo][łl]g[łl][óo]		# 12
pomagier		i		pomagier			# 5
prostak			i		\bprosta\w+			# 388
prymityw		i		prymityw\w*			# 485
psychiatra		im		psychiatr				# ???
psychiczny		im		psychicz				# ??? psycholog psychika
psychol			im		psychol(?!og)			# psycholog psychika
...
dawn			idm		\bd[ao][łlw]n(a|em|ach|om|owi)\b	# 1182 TODO dawny dawno dawni dawna
...
zaglada			ss		zagład				# 93 zagladalem
