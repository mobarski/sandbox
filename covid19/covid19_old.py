...
if __name__=="__main__":
	...
	if 0:
		...
		model.init_phrased_mp(2)
		exit()
	elif 0: # init
		# doc_iter = data.doc_iter(limit)
		# doc_iter = list(doc_iter)
		# print('doc_iter[0]',doc_iter[0])
		# print('doc_iter[1]',doc_iter[1])
		# print('doc_iter[2]',doc_iter[2])
		# exit()
		model.init_meta(data.doc_iter(limit), get_meta)
		model.init_sentencer(data.doc_iter(limit), **sentencer_cfg)
		#model.explain_sentencer(data.doc_iter(limit),100); exit()
		model.init_phraser(data.doc_iter(limit), **phraser_cfg)
		model.init_phrased(data.doc_iter(limit))
		...
		pprint(list(model.dictionary_query('(?i)shortag')))
		exit()
		model.load_tfidf()
		model.load_lsi()
		#
	...
	if 1:
		model.load_bow()
		model.init_sparse()
		#model.init_sparse_mp(3)
		print(model.sparse[0])
		print(model.sparse[1])
		print(len(model.sparse))
		exit()
		model.init_lsi(**lsi_cfg)
		#model.init_dense_mp(3)
		model.init_dense()
		print(model.dense[0])
		print(model.dense[1])
		print(len(model.dense))
		exit()
		# --- DENSE ---
	...
	print(model.phrased[0])
	print(model.phrased[1])
	print(model.phrased[2])
	print()
	...
	ids = [randint(0,len(model.meta)-1) for _ in range(1000)]
