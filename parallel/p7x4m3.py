...
if sys.version < '2.7':
	...
	parser.add_option('-e',type=str,default='mapper{}.log',help='path template for stderr (logs), must contain {} which will be replaced by partition id (mapper{}.log)')
	parser.add_option('-n',type=int,default=4,help='number of mapper jobs (4)')
	options,args = parser.parse_args()
	print(options,args)
	cmd_line_args = options
	cmd_line_args.mapper = args[0]
else:
	import argparse
